...
def myfunc(inputs):
    ...
    parser.add_argument('--class_agnostic', type=bool, default=False)
    parser.add_argument('--model', type=str, default='yolov8')
    parser.add_argument('--anchors', type=str, default='anchors_yolov7.txt',)
    ...
    outputs_p = inputs.copy()
    
    if boxes is not None:   
        draw(outputs_p, co_helper.get_real_box(boxes), scores, classes)
...
#     parser = argparse.ArgumentParser(description='Process some integers.')
#     # basic params
#     parser.add_argument('--model_path', type=str, default='./yolov8s_rknnopt_RK3588_fp.rknn', required= False, help='model path, could be .pt or .rknn file')
...
#     parser.add_argument('--model', type=str, default='yolov8', help='model type, support {}'.format(SUPPORT_MODEL))
